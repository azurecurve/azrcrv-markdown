 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_m')){
	function azrcrv_create_plugin_menu_m(){
		azrcrv_create_plugin_menu_table_m();
		azrcrv_populate_plugin_menu_table_m();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_m')){
	function azrcrv_populate_plugin_menu_table_m(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_m')){
	function azrcrv_create_plugin_menu_table_m(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
